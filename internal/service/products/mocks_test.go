...
func (_mock *RepositoryMock) AddProductReview(ctx context.Context, id string, reviewer string, text string, rating float64) (error) {
	_mock.mock.T.Helper()
...
func (_expecter _RepositoryMock_Expecter) AddProductReview(ctx match.Arg[context.Context], id match.Arg[string], reviewer match.Arg[string], text match.Arg[string], rating match.Arg[float64]) _RepositoryMock_AddProductReview_Call {
...
func (_call _RepositoryMock_AddProductReview_Call) RunReturn(f func(ctx context.Context, id string, reviewer string, text string, rating float64) (error)) _RepositoryMock_AddProductReview_Call {
