...
func (_mock *ServiceMock) ListProducts(_a0 int, _a1 int) (interface{}, error) {
	_mock.mock.T.Helper()
...
func (_call _ServiceMock_ListProducts_Call) Return(_r0 interface{}, _r1 error) _ServiceMock_ListProducts_Call {
	_call.Call.Return(_r0, _r1)
	return _call
}

func (_call _ServiceMock_ListProducts_Call) RunReturn(f func(int, int) (interface{}, error)) _ServiceMock_ListProducts_Call {
	_call.Call.RunReturn(f)
	return _call
}
